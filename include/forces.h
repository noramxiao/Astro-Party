...
typedef struct body_aux body_aux_t;
...
/**
 * Returns the body's list of bodies.
 *
 * @param body the body whose list of bodies is to be returned
 * @return pointer to list_t of bodies
 */
list_t *body_aux_bodies(body_aux_t *body);
